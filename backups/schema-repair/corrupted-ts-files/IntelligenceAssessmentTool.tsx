...
const ASSESSMENT_QUESTIONS: AssessmentQuestion[] = [
  // Operational Intelligence Questions
  {
    ...
    choices: [
      ...
      {
        text: 'Mostly manual with some automation',
        score: 30,
        insight: 'Partial automation exists',
      },
      {
        text: 'Balanced mix of manual and automated',
        score: 60,
        insight: 'Moderate automation level',
      },
      {
        text: 'Mostly automated with some manual oversight',
        score: 85,
        insight: 'Advanced automation',
      },
      {
  ...
  },
  {
    ...
    choices: [
      ...
      {
        text: 'Within an hour with some detective work',
        score: 70,
        insight: 'Good operational awareness',
      },
      {
        text: 'Minutes with clear diagnostics',
        score: 90,
        insight: 'Excellent system intelligence',
      },
      {
  ...
  },
  {
    ...
    choices: [
      {
        text: 'Email, calls, and meetings mostly',
        score: 20,
        insight: 'Communication friction high',
      },
      {
        text: 'Shared documents and spreadsheets',
        score: 40,
        insight: 'Basic information sharing',
      },
      {
        text: 'Some integrated systems and dashboards',
        score: 65,
        insight: 'Moderate integration',
      },
      {
  ...
  // Analytical Intelligence Questions
  {
    ...
    choices: [
      {
        text: 'Mostly gut feeling and experience',
        score: 25,
        insight: 'Intuition-based decisions',
      },
      {
        text: 'Some data with heavy reliance on intuition',
        score: 45,
        insight: 'Data-informed decisions',
      },
      {
        text: 'Data-driven with intuition as backup',
        score: 75,
        insight: 'Strong analytical foundation',
      },
      {
        text: 'Advanced analytics with predictive modeling',
        score: 92,
  ...
  },
  {
    ...
    choices: [
      ...
      {
        text: 'Sometimes we spot trends early',
        score: 45,
        insight: 'Occasional trend recognition',
      },
      {
        text: 'We often identify trends before others',
        score: 75,
        insight: 'Good market intelligence',
      },
      {
        text: 'We consistently predict market movements',
        score: 90,
        insight: 'Superior analytical capability',
      },
      {
  ...
  },
  {
    ...
    choices: [
      {
        text: 'Data exists but insights are unclear',
        score: 20,
        insight: 'Information without intelligence',
      },
      {
        text: 'Some useful insights but not always actionable',
        score: 50,
        insight: 'Basic analytical capability',
      },
      {
        text: 'Most insights lead to clear actions',
        score: 75,
        insight: 'Good insight-to-action conversion',
      },
      {
        text: 'Insights automatically trigger optimizations',
        score: 92,
  ...
  // Strategic Intelligence Questions
  {
    ...
    choices: [
      {
        text: 'We focus mostly on short-term survival',
        score: 10,
        insight: 'Survival mode operation',
      },
      {
        text: 'We have goals but strategy evolves constantly',
        score: 35,
        insight: 'Reactive strategic approach',
      },
      {
        text: 'Clear strategy with regular adjustments',
        score: 70,
        insight: 'Solid strategic foundation',
      },
      {
        text: 'Comprehensive strategy with precise execution',
        score: 90,
        insight: 'Advanced strategic intelligence',
      },
      {
  ...
  },
  {
    ...
    choices: [
      ...
      {
        text: 'We adapt but it takes significant effort',
        score: 45,
        insight: 'Moderate adaptability',
      },
      { text: 'We pivot effectively within weeks', score: 75, insight: 'Good strategic agility' },
      {
        text: 'We anticipate and pre-adapt to changes',
        score: 95,
        insight: 'Prophetic strategic intelligence',
      },
      {
  ...
  // Collaborative Intelligence Questions
  {
    ...
    choices: [
      {
        text: 'Knowledge stays trapped in individual minds',
        score: 20,
        insight: 'Knowledge silos dominate',
      },
      {
        text: 'Some knowledge sharing through documentation',
        score: 45,
        insight: 'Basic knowledge management',
      },
      {
        text: 'Regular knowledge sharing sessions and systems',
        score: 70,
        insight: 'Active knowledge circulation',
      },
      {
        text: 'Seamless knowledge flows across all teams',
        score: 88,
  ...
  },
  {
    ...
    choices: [
      {
        text: 'Collaboration often creates more confusion',
        score: 10,
        insight: 'Collaboration dysfunction',
      },
      {
        text: 'Teams work together but results are predictable',
        score: 40,
        insight: 'Additive collaboration',
      },
      {
        text: 'Good collaboration produces better outcomes',
        score: 70,
        insight: 'Synergistic collaboration',
      },
      {
        text: 'Teams consistently achieve exponential results',
        score: 90,
  ...
  // Adaptive Intelligence Questions
  {
    ...
    choices: [
      {
        text: 'Failures are avoided or hidden',
        score: 15,
        insight: 'Fear-based learning resistance',
      },
      { text: 'We eventually learn but it takes time', score: 45, insight: 'Slow learning cycles' },
      {
        text: 'Failures become learning opportunities quickly',
        score: 75,
        insight: 'Growth mindset active',
      },
      {
        text: 'Failures accelerate innovation immediately',
        score: 92,
  ...
  },
  {
    ...
    choices: [
      {
        text: 'We wait until technologies are proven',
        score: 20,
        insight: 'Conservative technology adoption',
      },
      {
        text: 'We adopt after seeing others succeed',
        score: 45,
        insight: 'Fast follower approach',
      },
      {
        text: 'We experiment with emerging technologies',
        score: 75,
        insight: 'Progressive technology integration',
      },
      {
        text: 'We pioneer new technology applications',
        score: 90,
...
const IntelligenceAssessmentTool: React.FC<IntelligenceAssessmentToolProps> = ({
  ...
  const calculateResult = useMemo((): AssessmentResult | null => {
    ...
    Object.entries(INTELLIGENCE_DIMENSIONS).forEach(([dimensionId, dimension]) => {
      ...
      dimensionScores[dimensionId as IntelligenceDimensionId] =
  ...
  return (
    <div
      className={`rounded-2xl border border-purple-700 bg-gradient-to-br from-indigo-900 via-purple-900 to-black p-8 ${className}`}
    >
      <AnimatePresence mode="wait">
        {currentStep === 'intro' && <IntroScreen onStart={startAssessment} />}
...
const IntroScreen: React.FC<{ onStart: () => void }> = ({ onStart }) => (
  ...
  >
    ...
    <div className="my-12 grid gap-6 md:grid-cols-5">
      {Object.values(INTELLIGENCE_DIMENSIONS).map((dimension) => (
        ...
        >
          <div className="mb-3 text-4xl">{dimension.icon}</div>
    ...
    return (
      ...
      >
        ...
        <h3 className="text-3xl font-thin text-white">
          Calculating Intelligence Multiplication Potential...
        </h3>
        <div className="mx-auto h-2 w-full max-w-md rounded-full bg-gray-700">
          <motion.div
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 text-center">
        <h3 className="mx-auto max-w-3xl text-2xl font-light text-white">{question.text}</h3>
        <p className="text-purple-300">{dimension.description}</p>
      </div>
      ...
      <div className="mx-auto max-w-4xl space-y-4">
        {question.choices.map((choice, index) => (
          <motion.button
            ...
            className="w-full rounded-xl border border-white/10 bg-white/5 p-4 text-left backdrop-blur-xl transition-all hover:border-purple-400/50 hover:bg-white/10"
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="mt-1 text-sm text-gray-400">{choice.insight}</div>
              </div>
...
const ResultsScreen: React.FC<{
  ...
  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-xl border border-white/20 bg-white/10 p-6 backdrop-blur-xl">
          <div className="text-3xl font-bold text-purple-400">
            {result.intelligenceMultiplier.toFixed(1)}x
          </div>
    ...
    {/* Dimension Breakdown */}
    <div className="space-y-4">
      <h3 className="text-center text-2xl text-white">Intelligence Dimensions</h3>
      <div className="grid gap-4 md:grid-cols-5">
        {Object.entries(result.dimensionScores).map(([dimensionId, score]) => {
          const dimension = INTELLIGENCE_DIMENSIONS[dimensionId as IntelligenceDimensionId]
          return (
            <div key={dimensionId} className="rounded-xl bg-black/30 p-4 text-center">
              <div className="mb-2 text-2xl">{dimension.icon}</div>
    ...
    <div className="grid gap-6 md:grid-cols-2">
      {result.blockers.length > 0 && (
        <div className="rounded-xl border border-red-700 bg-red-900/20 p-6">
          <h4 className="mb-4 text-lg font-semibold text-red-400">🚫 Intelligence Blockers</h4>
      ...
      <div className="rounded-xl border border-green-700 bg-green-900/20 p-6">
        <h4 className="mb-4 text-lg font-semibold text-green-400">💡 Recommendations</h4>
        <div className="space-y-2">
    ...
    <div className="rounded-xl border border-purple-700 bg-gradient-to-r from-purple-900/30 to-indigo-900/30 p-6">
      <h4 className="mb-4 text-lg font-semibold text-purple-400">🚀 Next Steps</h4>
      <div className="space-y-2">
    ...
    <div className="flex justify-center space-x-4">
      ...
      <motion.button
        className="rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-3 text-white"
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
      >
...
const IntelligenceVisualization: React.FC<{
  ...
  return (
    <div className="h-80 rounded-xl border border-gray-700 bg-black/30">
