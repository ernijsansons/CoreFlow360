...
const departments: Department[] = [
  {
    ...
    icon: Users,
    color: 'violet',
    description: 'AI-driven customer intelligence that predicts behavior, optimizes engagement, and maximizes lifetime value.',
    capabilities: [
      {
        name: 'Autonomous Lead Scoring',
        description: 'AI continuously evaluates and ranks prospects based on 200+ behavioral signals',
        aiPowered: true,
        automationLevel: 95
      },
      {
  ...
  },
  {
    ...
    icon: Calculator,
    color: 'blue',
    description: 'Financial AI that thinks like a CFO, predicts cash flow, and detects anomalies in real-time.',
    capabilities: [
      {
  ...
  },
  {
    ...
    icon: Brain,
    color: 'emerald',
    description: 'HR AI that predicts performance, optimizes hiring, and prevents turnover before it happens.',
    capabilities: [
      {
  ...
  },
  {
    ...
    icon: Wrench,
    color: 'orange',
    description: 'Field service AI that optimizes routes, predicts equipment failures, and maximizes technician efficiency.',
    capabilities: [
      {
  ...
  },
  {
    ...
    icon: BarChart3,
    color: 'cyan',
    description: 'Analytics AI that transforms data into actionable insights and predictive business intelligence.',
    capabilities: [
      {
  ...
  },
  {
    ...
    icon: Shield,
    color: 'pink',
    description: 'Security AI that monitors, detects, and responds to threats faster than any human security team.',
    capabilities: [
      {
...
export default function FeaturesPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container-fluid relative z-10">
          ...
          >
            ...
            <p className="text-body-large text-gray-300 mb-12">
              Every department enhanced by AI. Every process optimized by intelligence. 
              Every decision powered by predictive analytics. This is the future of business operations.
            </p>
      ...
      <section id="departments" className="py-16 bg-gray-950">
        <div className="container-fluid">
          ...
          >
            ...
            <p className="text-body-large text-gray-400 max-w-3xl mx-auto">
              Select any department to see how artificial intelligence transforms traditional business processes.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="text-center mb-16">
              <motion.div
                ...
                className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-r from-violet-500 to-cyan-500 mb-6"
              >
                <selectedDepartment.icon className="w-10 h-10 text-white" />
              </motion.div>
                    ...
                    >
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            {capability.aiPowered && (
                              <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-violet-500/20 border border-violet-500/30">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="text-violet-400 font-medium">{capability.automationLevel}%</span>
                        </div>
        ...
        <div className="container-fluid text-center">
          ...
          >
            ...
            <p className="text-body-large text-gray-300 mb-12 max-w-2xl mx-auto">
              Experience the power of artificial intelligence across every department. 
