...
const nextConfig = {
  ...
  webpack: (config, { buildId, dev, isServer, defaultLoaders, webpack }) => {
    ...
    config.optimization = {
      ...
      splitChunks: {
        ...
        cacheGroups: {
          ...
          // Data libraries
          data: {
            test: /[\\/]node_modules[\\/](@tanstack|@prisma|axios|swr)[\\/]/,
            name: 'data-libs',
            chunks: 'all',
            priority: 30
          },
          ...
          forms: {
            test: /[\\/]node_modules[\\/](react-hook-form|zod|yup)[\\/]/,
            name: 'form-libs',
            chunks: 'all',
            priority: 25
          },
          ...
          utils: {
            test: /[\\/]node_modules[\\/](date-fns|dayjs|lodash|ramda)[\\/]/,
            name: 'util-libs',
            chunks: 'all',
            priority: 20
          },
    ...
    // Disabled for now - incompatible with current webpack version
    // if (!dev) {
    //   const BundleOptimizerPlugin = require('./webpack/bundle-optimizer')
    //   const preset = process.env.NODE_ENV === 'production' ? 'production' : 'development'
    //   
    //   config.plugins.push(
    //     new BundleOptimizerPlugin(BundleOptimizerPlugin.presets[preset])
    //   )
    // }
