 ...
 * 
 * Generated from: 07-intelligence-factory.md
 * 
...
interface IntelligenceFactoryProps {
  className?: string
}

export default function IntelligenceFactory({ className = '' }: IntelligenceFactoryProps) {
...
1. Read the full prompt content in: 07-intelligence-factory.md
