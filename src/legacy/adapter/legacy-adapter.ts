...
export interface LegacyService {
  // CRM Operations
  getCustomers(params?: unknown): Promise<LegacyResponse>
  createCustomer(data: unknown): Promise<LegacyResponse>
  updateCustomer(id: string, data: unknown): Promise<LegacyResponse>
  deleteCustomer(id: string): Promise<LegacyResponse>

  // Accounting Operations
  getInvoices(params?: unknown): Promise<LegacyResponse>
  createInvoice(data: unknown): Promise<LegacyResponse>
  getFinancialReports(type: string, params?: unknown): Promise<LegacyResponse>

  // Project Operations
  getProjects(params?: unknown): Promise<LegacyResponse>
  createProject(data: unknown): Promise<LegacyResponse>
...
export class LegacyAdapter implements LegacyService {
   ...
   */
  async getCustomers(params?: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'getCustomers',
      async () => {
        // Route to Twenty CRM plugin
        const result = await this.callPluginAPI(ModuleType.CRM, 'GET', '/api/crm/companies', params)
  ...
  async createCustomer(data: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'createCustomer',
      async () => {
  ...
  async updateCustomer(id: string, data: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'updateCustomer',
      async () => {
        const transformedData = this.transformCustomerData(data)
   ...
   */
  async getInvoices(params?: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'getInvoices',
      async () => {
        const result = await this.callPluginAPI(
  ...
  async createInvoice(data: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'createInvoice',
      async () => {
  ...
  async getFinancialReports(type: string, params?: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'getFinancialReports',
      async () => {
        const result = await this.callPluginAPI(
   ...
   */
  async getProjects(params?: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'getProjects',
      async () => {
        const result = await this.callPluginAPI(
  ...
  async createProject(data: unknown): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'createProject',
      async () => {
  ...
  async analyzeCustomer(customerId: string): Promise<LegacyResponse> {
    return await this.adaptLegacyCall(
      'analyzeCustomer',
      async () => {
        const result = await this.callPluginAPI(ModuleType.CRM, 'POST', '/api/crm/ai/analyze', {
          customerId,
        })
  ...
  private transformToLegacyFormat(data: unknown, type: string): unknown {
  ...
  private transformCustomerData(legacyData: unknown): unknown {
    return {
  ...
  private transformInvoiceData(legacyData: unknown): unknown {
    return {
  ...
  private transformProjectData(legacyData: unknown): unknown {
    return {
  ...
  private transformCustomersToLegacy(data: unknown): unknown {
  ...
  private transformInvoicesToLegacy(data: unknown): unknown {
    if (Array.isArray(data)) {
  ...
  private transformProjectsToLegacy(data: unknown): unknown {
    if (Array.isArray(data)) {
...
export class LegacyAPIRouter {
  ...
  // Route handlers
  private async handleGetCustomers(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.getCustomers(req.query)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleCreateCustomer(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.createCustomer(req.body)
    res.status(result.success ? 201 : 400).json(result)
  }

  private async handleUpdateCustomer(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.updateCustomer(req.params.id, req.body)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleDeleteCustomer(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.deleteCustomer(req.params.id)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleGetInvoices(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.getInvoices(req.query)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleCreateInvoice(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.createInvoice(req.body)
    res.status(result.success ? 201 : 400).json(result)
  }

  private async handleGetFinancialReports(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.getFinancialReports(req.params.type, req.query)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleGetProjects(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.getProjects(req.query)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleCreateProject(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.createProject(req.body)
    res.status(result.success ? 201 : 400).json(result)
  }

  private async handleUpdateProjectStatus(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.updateProjectStatus(req.params.id, req.body.status)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleAnalyzeCustomer(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.analyzeCustomer(req.params.id)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handlePredictChurn(req: unknown, res: unknown): Promise<void> {
    const result = await this.adapter.predictChurn(req.params.id)
    res.status(result.success ? 200 : 400).json(result)
  }

  private async handleGetRecommendations(req: unknown, res: unknown): Promise<void> {
