...
export async function requestSignatureMiddleware(
  ...
  if (process.env.NODE_ENV === 'development' && 
    ...
    console.log(`🔓 Request signing disabled in development for ${pathname}`);
    return null;
  }
  ...
  try {
    ...
    console.error('Request signature middleware error:', error);
 ...
 */
export function withSignatureValidation<T extends any[]>(
