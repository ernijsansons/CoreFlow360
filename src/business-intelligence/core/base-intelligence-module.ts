...
export abstract class BaseIntelligenceModule extends EventEmitter {
  ...
  getIntelligenceLevel(): number {
    return this.getBusinessIntelligenceLevel()
  }
...
export type IntelligenceState = BusinessIntelligenceState
export type IntelligenceMetrics = BusinessIntelligenceMetrics
export type IntelligenceInsight = BusinessIntelligenceInsight
export type ConsciousnessState = BusinessIntelligenceState
export type ConsciousnessMetrics = BusinessIntelligenceMetrics
export type ConsciousnessInsight = BusinessIntelligenceInsight
