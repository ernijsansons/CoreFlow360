  ...
  return (
    <button
      ...
      className={`
        ...
        ${languageConfig.direction === 'rtl' ? 'flex-row-reverse' : ''}
        ${className}
      `}
    >
      {loading ? (
    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          className={`
            w-full px-4 py-3 bg-gray-800 border rounded-lg transition-all duration-200
        ...
        {type === 'password' && (
          <button
            ...
            } p-1 text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-violet-500 rounded`}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            role="listbox"
            aria-labelledby={selectId}
            className="absolute z-50 w-full mt-1 bg-gray-800 border border-gray-700 rounded-lg shadow-2xl max-h-60 overflow-y-auto"
          >
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-800">
          ...
          <button
            onClick={onClose}
            className="p-2 text-gray-400 hover:text-white transition-colors rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500"
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <Icon 
          className={`${config.iconColor} w-5 h-5 flex-shrink-0 mt-0.5`}
          aria-hidden="true"
        />
        
        <div className="flex-1">
          {title && (
            <h3 className={`${config.titleColor} font-semibold mb-2`}>
              {title}
            </h3>
          )}
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="p-1 text-gray-400 hover:text-white transition-colors rounded focus:outline-none focus:ring-2 focus:ring-violet-500"
...
export function AccessibleProgress({
  ...
  return (
    <div className={`space-y-2 ${className}`}>
      ...
      <div 
        className={`w-full bg-gray-800 rounded-full ${sizes[size]}`}
        role="progressbar"
        aria-valuenow={value}
        aria-valuemin={0}
        aria-valuemax={max}
