      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-body-large text-gray-400 max-w-3xl mx-auto">
            Don't take our word for it. Here's what happens when you let AI run your business. 
            These are real customers who went from drowning in spreadsheets to running businesses on autopilot.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gray-900/40 backdrop-blur-sm border border-violet-500/30 rounded-2xl p-8 max-w-2xl mx-auto">
            <div className="text-2xl font-bold text-white mb-4">
              Your Success Story Starts Here
            </div>
            <div className="text-gray-300 mb-6">
              Join 1,847 businesses already running on autopilot. 
              Your AI starts learning your business in 60 seconds.
            </div>
