...
export default function AdvancedSequenceBuilder() {
  ...
  const [activeTab, setActiveTab] = useState<'builder' | 'audience' | 'testing' | 'analytics'>(
    'builder'
  )
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-400">Multi-channel campaigns with AI personalization</p>
        </div>
        <div className="flex items-center space-x-3">
          <div className="rounded-lg border border-green-500/30 bg-gradient-to-r from-green-500/20 to-emerald-500/20 px-4 py-2">
            <div className="flex items-center space-x-2">
              <FireIcon className="h-5 w-5 text-green-400" />
              <span className="font-medium text-green-300">Sequence Engine - $99/month</span>
            </div>
          </div>
        ...
        <div className="w-80 space-y-4">
          <div className="rounded-xl border border-gray-800 bg-gray-900/60 p-4">
            <div className="mb-4 flex items-center justify-between">
              ...
              <AccessibleButton size="sm" onClick={() => setShowNewSequenceModal(true)}>
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
                      <div>
                        ...
                        <span className="ml-1 text-gray-300">
                          {sequence.metrics.activeContacts}
                        </span>
                      </div>
                      <div>
          ...
          {/* AI Assistant */}
          <div className="rounded-xl border border-purple-500/30 bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-4">
        ...
        <div className="flex-1">
          {selectedSequence ? (
                ...
                <AnimatePresence mode="wait">
                  {activeTab === 'builder' && (
                    ...
                    >
                            ...
                            {selectedSequence.steps.map((step, index) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div
                                    className={`rounded-lg border p-4 ${getStepColor(step.type)} relative`}
                                  >
                                    <div className="flex items-start justify-between">
                                          ...
                                          {step.metrics && (
                                            <div className="mt-3 flex items-center space-x-4 text-xs">
                                              ...
                                              <span className="text-green-400">
                                                Replied: {step.metrics.replied} (
                                                {Math.round(
                                                  (step.metrics.replied / step.metrics.sent) * 100
                                                )}
                                                %)
                                              </span>
                                            </div>
                      ...
                      <div className="pt-4">
                        ...
                        <div className="rounded-lg border-2 border-dashed border-gray-700 p-4">
                          <p className="mb-3 text-center text-sm text-gray-400">
                            Add a step to your sequence
                          </p>
                            ...
                            {[
                              ...
                              return (
                                <button
                                  ...
                                  className="flex flex-col items-center rounded-lg bg-gray-800 p-3 transition-colors hover:bg-gray-700"
                                >
                  ...
                  {activeTab === 'audience' && (
                    ...
                    >
                      <div className="rounded-lg bg-gray-800/50 p-6">
                        <h3 className="mb-4 text-lg font-medium text-white">Audience Filters</h3>
                        <div className="space-y-4">
                          {selectedSequence.audience.filters.map((filter, index) => (
                            <div key={index} className="flex items-center space-x-3">
                              ...
                              />
                              <AccessibleInput value={filter.value} placeholder="Value" />
                        ...
                        <div className="mt-6 rounded-lg border border-purple-500/30 bg-purple-900/20 p-4">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-2xl font-bold text-white">
                                {selectedSequence.audience.size}
                              </p>
                            </div>
                            <AccessibleButton variant="secondary" size="sm">
                  ...
                  {activeTab === 'testing' && (
                    <motion.div
                      ...
                      className="space-y-6"
                    >
                      <div className="rounded-lg border border-purple-500/30 bg-gradient-to-r from-purple-900/20 to-pink-900/20 p-6">
                        ...
                        {selectedSequence.variants && selectedSequence.variants.length > 0 ? (
                          <div className="space-y-4">
                            {selectedSequence.variants.map((variant) => (
                              <div key={variant.id} className="rounded-lg bg-gray-800/50 p-4">
                          ...
                          <div className="py-8 text-center">
                            <BeakerIcon className="mx-auto mb-3 h-12 w-12 text-gray-600" />
                            <p className="mb-4 text-gray-400">No variants created yet</p>
                            <AccessibleButton>
                  ...
                  {activeTab === 'analytics' && (
                    ...
                    >
                      <div className="grid gap-6 md:grid-cols-2">
                        <div className="rounded-lg bg-gray-800/50 p-6">
                          <h3 className="mb-4 text-lg font-medium text-white">Funnel Analysis</h3>
                          <div className="space-y-3">
                            <div className="flex items-center justify-between">
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-900/60 p-12 text-center">
              ...
              <p className="mb-4 text-gray-400">Select a sequence to get started</p>
        ...
        {showStepModal && selectedStep && (
          ...
          >
            <motion.div
              ...
              className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-gray-700 bg-gray-900 p-6"
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <label className="mb-2 block text-sm font-medium text-white">Step Name</label>
                  <AccessibleInput value={selectedStep.name} placeholder="Enter step name" />
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    <label className="mb-2 block text-sm font-medium text-white">Delay Type</label>
                    <AccessibleSelect
                  ...
                  {selectedStep.delay.type !== 'IMMEDIATE' && (
                    <div>
                      ...
                      <AccessibleInput type="number" value={selectedStep.delay.value} min="1" />
                    </div>
                  )}
                </div>

                <div className="flex justify-end space-x-3 pt-4">
                  <AccessibleButton variant="secondary" onClick={() => setShowStepModal(false)}>
                    Cancel
                  </AccessibleButton>
        ...
        {showAIAssistant && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="w-full max-w-lg rounded-2xl border border-gray-700 bg-gray-900 p-6"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center space-x-3">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-purple-500/30 bg-gradient-to-r from-purple-900/20 to-pink-900/20 p-4">
                  <h3 className="mb-2 font-medium text-purple-300">Optimization Suggestions</h3>
                  <ul className="space-y-2 text-sm text-purple-200">
                    <li className="flex items-start">
                      <LightBulbIcon className="mt-0.5 mr-2 h-4 w-4 flex-shrink-0" />
                      Add a LinkedIn connection request before the message for 40% higher response
                      rate
                    </li>
                    <li className="flex items-start">
                      <LightBulbIcon className="mt-0.5 mr-2 h-4 w-4 flex-shrink-0" />
                ...
                <div>
                  <h3 className="mb-2 font-medium text-white">Ask AI Assistant</h3>
                  <AccessibleTextarea
