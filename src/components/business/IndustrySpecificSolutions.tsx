    ...
    <div className={`min-h-screen bg-white ${className}`}>
      ...
      <div className="bg-gradient-to-br from-slate-900 to-blue-900 py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="mb-6 text-4xl font-bold md:text-6xl">Industry Specific Solutions</h1>
          <p className="mx-auto max-w-3xl text-xl text-blue-100 md:text-2xl">
            Industry-focused solutions for Manufacturing, Professional Services, Retail,
