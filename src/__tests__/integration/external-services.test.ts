...
import { POST as FinGPT_POST, GET as FinGPT_GET } from '@/lib/app/api/ai/fingpt/route'
import { POST as FinRobot_POST, GET as FinRobot_GET } from '@/lib/app/api/ai/finrobot/route'
