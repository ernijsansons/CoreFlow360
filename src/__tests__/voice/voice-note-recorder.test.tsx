...
import { VoiceNoteRecorder } from '@/lib/components/voice/VoiceNoteRecorder'
import { useVoiceNoteWebSocket } from '@/lib/hooks/useVoiceNoteWebSocket'
...
describe('VoiceNoteRecorder', () => {
  ...
  describe('Real-time Transcription', () => {
    it('should display transcription in real-time', async () => {
      ...
      const mockOnTranscription = (useVoiceNoteWebSocket as jest.Mock).mock.calls[0][0]
        .onTranscription
