...
export const apiOperations = {
  ...
  customers: {
    list: (params?: unknown) =>
      standardApiClient.get('/api/customers', {
        method: 'GET',
        headers: params ? { 'X-Query-Params': JSON.stringify(params) } : undefined,
      }),
    get: (id: string) => standardApiClient.get(`/api/customers/${id}`),
    create: (data: unknown) => standardApiClient.post('/api/customers', data),
    update: (id: string, data: unknown) => standardApiClient.put(`/api/customers/${id}`, data),
  ...
  subscriptions: {
    ...
    calculatePricing: (data: unknown) => secureApiClient.post('/api/subscriptions/calculate', data),
    createCheckout: (data: unknown) => secureApiClient.post('/api/subscriptions/checkout', data),
  },
...
export const devUtils = {
   ...
   */
  testSignedEndpoint: async (endpoint: string, method = 'GET', body?: unknown) => {
    if (process.env.NODE_ENV !== 'development') {
