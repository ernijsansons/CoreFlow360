...
Keep responses under 30 seconds. Speak clearly and professionally.`,
  ...
  objectionHandling: {
    "too_expensive": "I understand budget is important. We offer flexible financing options and free estimates. Many times, a small repair can extend your system's life significantly. Would you like me to schedule a free diagnostic?",
    "need_to_think": "Absolutely, this is an important decision. How about I schedule you for a free estimate so you have all the information you need? There's no obligation, and you'll know exactly what you're dealing with.",
    "already_have_someone": "That's great that you have a regular service provider. Sometimes it helps to get a second opinion, especially for major repairs. Our estimates are always free. Would that be helpful?",
    "not_interested": "I understand. If your situation changes or you need emergency service, please keep us in mind. We're available 24/7 for HVAC emergencies. Have a great day!",
    "call_back_later": "Of course! When would be a better time to reach you? I can schedule a quick callback at your convenience."
  },
...
Keep responses under 30 seconds. Be professional but caring.`,
  ...
  objectionHandling: {
    "not_at_fault": "I understand this wasn't your fault. We'll work with the other party's insurance to handle this properly. Let me get your claim started so we can protect your interests and get your car fixed.",
    "deductible_concerns": "I know the deductible can be a concern. If the other party is at fault, their insurance should cover everything. Let's get the claim documented first, and we'll sort out the financial details.",
    "prefer_own_shop": "Absolutely, you can choose your repair shop. We work with many quality shops in your area, or you can use your preferred location. The important thing is getting this claim started.",
    "too_busy": "I understand you're dealing with a lot right now. This will only take a few minutes, and it'll actually save you time later. I can handle most of the paperwork for you.",
    "minor_damage": "Even minor damage can be more expensive than it looks. It's always worth getting it properly inspected. The inspection is free and there's no obligation to proceed if the damage is minimal."
  },
...
Keep responses under 30 seconds. Be professional and helpful.`,
  ...
  objectionHandling: {
    "too_busy": "I completely understand - running a business keeps you swamped. That's exactly why automation tools like ours can be so valuable. What if I could show you how to get 10 hours back per week? Would 15 minutes be worth that?",
    "happy_current_system": "That's great to hear! What do you like most about your current setup? I'm curious - are there any small frustrations or things you wish worked differently?",
    "too_expensive": "I understand budget is always a consideration. Many of our clients find that CoreFlow360 actually saves them money by reducing manual work and preventing lost leads. What are you currently spending on business software monthly?",
    "need_to_research": "Smart approach - this is an important decision. What specific areas would you like to research? I can send you some resources and maybe schedule a brief demo when you're ready to see it in action.",
    "not_decision_maker": "I appreciate your honesty. Who typically handles software decisions at your company? Would it make sense to include them in our next conversation?"
  },
...
export class VoiceScriptManager {
   ...
   */
  customizeScript(baseScript: VoiceScript, customizations: {
    companyName?: string
    contactName?: string
    specificNeed?: string
