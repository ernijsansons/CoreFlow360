...
export class AutomationTemplatesLibrary {
  ...
  getTemplatesByIndustry(industry: string): WorkflowTemplate[] {
    return this.templates.filter(
      (t) => !t.industry || t.industry === industry || t.industry === 'General'
    )
  }
  ...
  customizeTemplate(
    ...
    workflow.nodes = workflow.nodes.map((node) => {
      const nodeCustomizations = template.customizationOptions.filter((c) => c.nodeId === node.id)
      ...
      nodeCustomizations.forEach((customization) => {
        if (customizations[customization.nodeId + '_' + customization.field]) {
          ...
          updatedNode = this.applyCustomizationToNode(
            updatedNode,
            customization,
            value,
            userContext
  ...
  private createNewLeadWelcomeTemplate(): WorkflowTemplate {
    ...
    return {
      ...
      templateWorkflow: {
        ...
        originalDescription:
          'When someone fills out our contact form, add them to CRM, send welcome email, and create follow-up task',
        generatedByAI: false,
        executionCount: 0,
        successRate: 0,
      },
  ...
  private createInvoiceReminderTemplate(): WorkflowTemplate {
    ...
    return {
      ...
      templateWorkflow: {
        ...
        originalDescription:
          'Daily check for overdue invoices, send reminders, and notify accounting team',
        generatedByAI: false,
        executionCount: 0,
        successRate: 0,
      },
  ...
  private createCustomerOnboardingTemplate(): WorkflowTemplate {
    ...
    return {
      ...
      description:
        'Full customer onboarding with project creation, CSM assignment, and kickoff scheduling',
      ...
      templateWorkflow: {
        ...
        originalDescription:
          'When customer signs contract, create onboarding project, assign success manager, send welcome email, and schedule kickoff call',
        generatedByAI: false,
        executionCount: 0,
        successRate: 0,
      },
  ...
  private createTicketAutoAssignmentTemplate(): WorkflowTemplate {
    ...
    return {
      ...
      description:
        'Automatically analyze, prioritize, and assign support tickets to the right agents',
      ...
      templateWorkflow: {
        ...
        connections: [
          {
            id: 'conn1',
            sourceNodeId: 'new_ticket',
            sourceOutputId: 'main',
            targetNodeId: 'analyze_priority',
            targetInputId: 'main',
          },
          {
            id: 'conn2',
            sourceNodeId: 'analyze_priority',
            sourceOutputId: 'main',
            targetNodeId: 'assign_agent',
            targetInputId: 'main',
          },
          {
            id: 'conn3',
            sourceNodeId: 'assign_agent',
            sourceOutputId: 'main',
            targetNodeId: 'send_confirmation',
            targetInputId: 'main',
          },
        ],
        settings: {
        ...
        originalDescription:
          'When support email arrives, analyze priority, assign to right agent, and confirm receipt',
        generatedByAI: false,
        executionCount: 0,
        successRate: 0,
      },
  ...
  private createLeadNurturingTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.LEAD_MANAGEMENT
    )
  }
  ...
  private createWelcomeSeriesTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      'welcome_email_series',
      'Welcome Email Series',
      WorkflowTemplateCategory.CUSTOMER_ONBOARDING
    )
  }

  private createAccountSetupTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      'account_setup_automation',
  ...
  private createPaymentConfirmationTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.INVOICE_MANAGEMENT
    )
  }
  ...
  private createEscalationTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.SUPPORT_TICKETS
    )
  }
  ...
  private createProjectKickoffTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.PROJECT_MANAGEMENT
    )
  }
  ...
  private createEmployeeOnboardingTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.HR_PROCESSES
    )
  }
  ...
  private createEmailCampaignTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.MARKETING_AUTOMATION
    )
  }
  ...
  private createOpportunityCreationTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.SALES_PIPELINE
    )
  }
  ...
  private createDataRetentionTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.COMPLIANCE
    )
  }
  ...
  private createWeeklyReportTemplate(): WorkflowTemplate {
    return this.createBasicTemplate(
      ...
      WorkflowTemplateCategory.REPORTING
    )
  }
