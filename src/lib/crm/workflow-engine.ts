...
export interface WorkflowAction {
  type: 'send_email' | 'create_task' | 'update_field' | 'create_notification' | 'ai_analysis' | 'webhook' | 'assign_to_user'
...
export class CRMWorkflowEngine {
   ...
   * Action: Update Field
   */
  private async updateFieldAction(config: any, context: any): Promise<void> {
   ...
   */
  private async createNotificationAction(config: any, context: any): Promise<void> {
   ...
   * Action: AI Analysis
   */
  private async aiAnalysisAction(config: any, context: any): Promise<void> {
   ...
   * Action: Webhook
   */
  private async webhookAction(config: any, context: any): Promise<void> {
   ...
   */
  private async assignToUserAction(config: any, context: any): Promise<void> {
   ...
   */
  private resolveEmailRecipients(recipients: string | string[], context: any): string[] {
   ...
   * Resolve user ID
   */
  private resolveUserId(assignTo: string, context: any): string {
   ...
   */
  private resolveUserIds(users: string | string[], context: any): string[] {
        ...
        actions: [
          {
            ...
            config: {
              ...
              message: 'New lead {{firstName}} {{lastName}} with score {{aiScore}} requires immediate attention',
