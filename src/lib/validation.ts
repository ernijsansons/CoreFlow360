 ...
 */
export const numericSchema = (min: number, max: number) => z.number()
...
export const arraySchema = <T>(itemSchema: z.ZodType<T>, maxLength: number) => 
  z.array(itemSchema)
    .max(maxLength, `Array too long (max ${maxLength} items)`)
...
export class ValidationUtils {
  ...
  static validateMultiple(
    validations: Array<{ field: string; schema: z.ZodType<any>; value: unknown }>
