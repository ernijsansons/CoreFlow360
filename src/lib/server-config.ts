 ...
 */
export function withShutdownHandling<T>(handler: (req: unknown, res: unknown) => Promise<T>) {
  return async (req: unknown, res: unknown): Promise<T | void> => {
