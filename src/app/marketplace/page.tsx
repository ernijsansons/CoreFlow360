...
export default function AIMarketplace() {
  ...
  const mockAgents: AIAgent[] = [
    {
      ...
      longDescription:
        'Transform your lead qualification process with our advanced AI that analyzes 200+ data points to predict lead conversion probability with 94% accuracy. Integrates seamlessly with your existing CRM and provides real-time insights.',
      category: 'sales',
    ...
    },
    {
      ...
      longDescription:
        'See your financial future with unprecedented clarity. Our AI analyzes historical data, market trends, and business patterns to predict cash flow, identify risks, and suggest optimizations 6 months ahead.',
      category: 'finance',
    ...
    },
    {
      ...
      longDescription:
        'Never lose a customer to dissatisfaction again. Our AI monitors customer sentiment across emails, calls, support tickets, and social media, alerting you before issues escalate.',
      category: 'sales',
    ...
    },
    {
      ...
      description:
        'Identify and eliminate workflow bottlenecks with AI-powered process optimization',
      longDescription:
        'Boost productivity by 40% with intelligent workflow analysis. Our AI maps your processes, identifies bottlenecks, and automatically suggests optimizations that save hours every week.',
      category: 'operations',
  ...
  const handleConfirmInstall = async () => {
    ...
    if (typeof window !== 'undefined' && (window as unknown).gtag) {
      ;(window as unknown).gtag('event', 'ai_agent_installed', {
          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="max-w-lg flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-700/50 bg-gray-800/50 py-3 pr-4 pl-10 text-white placeholder-gray-400 focus:border-violet-500 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <select
                ...
                className="rounded-xl border border-gray-700/50 bg-gray-800/50 px-4 py-3 text-white focus:border-violet-500 focus:outline-none"
              >
              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center rounded-xl p-3 text-left transition-all ${
                      selectedCategory === category.id
                        ? 'border border-violet-500/50 bg-violet-600/20 text-violet-300'
          ...
          <div className="lg:col-span-3">
              ...
              <AnimatePresence>
                {filteredAgents.map((agent, index) => (
                  <motion.div
                    ...
                    className="group rounded-2xl border border-gray-700/50 bg-gray-800/40 p-6 backdrop-blur-sm transition-all hover:border-gray-600/50"
                  >
                    {/* Agent Header */}
                    <div className="mb-4 flex items-start justify-between">
                      <div className="flex items-center">
                        <div className="mr-3 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-violet-500 to-cyan-500">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">by {agent.developer}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {agent.trending && (
                          <TrendingUp className="h-4 w-4 text-orange-500" title="Trending" />
                        )}
                      </div>
                    </div>

                    {/* Description */}
                    <p className="mb-4 line-clamp-2 text-sm text-gray-300">{agent.description}</p>
                    ...
                    <button
                      ...
                      className="group flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-violet-600 to-cyan-600 py-2 font-medium text-white transition-all hover:from-violet-700 hover:to-cyan-700"
                    >
                      Install Agent
            ...
            {filteredAgents.length === 0 && (
              <div className="py-12 text-center">
                ...
                <h3 className="mb-2 text-lg font-medium text-gray-400">No agents found</h3>
        ...
        {showInstallModal && selectedAgent && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-2xl rounded-2xl border border-gray-700/50 bg-gradient-to-br from-gray-900/95 to-gray-800/95 p-8 backdrop-blur-xl"
            >
              ...
              <div className="mb-6 flex items-center">
                <div className="mr-4 flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-r from-violet-500 to-cyan-500">
              ...
              <div className="mb-6 rounded-xl bg-gray-800/40 p-4">
                <h4 className="mb-2 font-semibold text-white">What you'll get:</h4>
              ...
              <div className="mb-6 rounded-xl border border-violet-500/30 bg-violet-600/20 p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-semibold text-white">
                      {selectedAgent.pricing.model === 'free'
                        ? 'Free'
              ...
              <div className="flex space-x-4">
                <button
                  onClick={() => setShowInstallModal(false)}
                  className="flex-1 rounded-xl border border-gray-600 py-3 text-gray-300 transition-all hover:border-gray-500"
                >
                  Cancel
                </button>
                <button
                  onClick={handleConfirmInstall}
                  className="flex-1 rounded-xl bg-gradient-to-r from-violet-600 to-cyan-600 py-3 font-semibold text-white transition-all hover:opacity-90"
                >
                  Install Now
                </button>
              </div>
