...
async function getHandler(request: NextRequest) {
  try {
    ...
    console.error('Failed to process schema request:', error);
...
async function handleListSchemas(endpoint?: string, method?: string) {
  ...
  const mockSchemas = [
    ...
    { endpoint: '/api/customers', method: 'POST', version: '1.0.0', description: 'Create customer' },
    { endpoint: '/api/customers/{id}', method: 'GET', version: '1.0.0', description: 'Get customer' },
    { endpoint: '/api/admin/webhook-dlq/metrics', method: 'GET', version: '1.0.0', description: 'DLQ metrics' },
    { endpoint: '/api/subscriptions/current', method: 'GET', version: '1.0.0', description: 'Current subscription' }
  ];
...
async function handleRegisterSchema(data: any) {
  try {
